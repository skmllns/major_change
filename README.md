...
# description
In order to track movement between colleges at a private university, students' enrollment over the course of 6 semesters was coded into a 1-6 letter sequence. In the example of code 'PPURBBB,' a student started at college P, remained there for the second semester, switched to college R in their third semester, then moved to college B and remained there for the following three semesters.
